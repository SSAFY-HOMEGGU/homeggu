...
export default function Header() {
  return (
    <header className="w-full h-[4rem] flex items-center justify-between  bg-white">
      ...
      <div className="flex items-center border p-2 rounded mr-4 h-[1.8rem]">
        ...
        <img src="/icons/sell.svg" alt="Chat Icon" className="w-[1rem] mr-1 ml-1" />
        <button className="text-[0.65rem] ml-1" >판매하기</button>
        <h4 className="text-gray-200 ml-1 font-light">|</h4>
        <img src="/icons/chat.svg" alt="Chat Icon" className="w-[1rem] mr-1 ml-1" />
        <button className="text-[0.65rem] ml-1" >채팅하기</button>
        <h4 className="text-gray-200 ml-1 font-light">|</h4>
        <img src="/icons/profile.svg" alt="Chat Icon" className="w-[1rem] mr-1 ml-1" />
